...
/// <summary>
/// Detailed view of a single <see cref="Volo.Abp.AuditLogging.EntityChange"/>
/// including its <see cref="PropertyChanges"/>. Mirrors ABP Commercial
/// AuditLogging Pro's entity-change detail endpoint.
/// </summary>
public class EntityChangeDetailDto
{
    public Guid Id { get; set; }
    public Guid AuditLogId { get; set; }
    public string? EntityTypeFullName { get; set; }
