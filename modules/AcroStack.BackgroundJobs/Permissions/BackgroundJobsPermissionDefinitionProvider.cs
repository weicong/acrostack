...
public class BackgroundJobsPermissionDefinitionProvider : PermissionDefinitionProvider
{
    public override void Define(IPermissionDefinitionContext context)
    {
        ...
        var bgJobPermission = group.AddPermission(
            BackgroundJobsPermissions.Default,
            L("Permission:BackgroundJobs"),
            MultiTenancySides.Host
        );
        bgJobPermission.AddChild(
            BackgroundJobsPermissions.ViewJobs,
            L("Permission:BackgroundJobs.ViewJobs")
        );
        bgJobPermission.AddChild(
        ...
        bgJobPermission.AddChild(
            BackgroundJobsPermissions.Requeue,
            L("Permission:BackgroundJobs.Requeue")
        );
        bgJobPermission.AddChild(
            BackgroundJobsPermissions.Abandon,
            L("Permission:BackgroundJobs.Abandon")
        );
    }
