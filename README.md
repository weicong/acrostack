...
- Check the `ConnectionStrings` in `appsettings.json` file under the `AcroStack` project and change it if you need.
...
- `AcroStack`: ASP.NET Core API host application.
...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p fb154108-8320-45ec-b081-fda4942fcf1f
```

> `fb154108-8320-45ec-b081-fda4942fcf1f` is the password of the certificate, you can change it to any password you want.
