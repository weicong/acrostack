...
public class AuditLogAppService : AcroStackAppService, IAuditLogAppService
{
    ...
    [Authorize(AcroStackPermissions.AuditLogging.Delete)]
    ...
    [Authorize(AcroStackPermissions.AuditLogging.ViewEntityChanges)]
    ...
    [Authorize(AcroStackPermissions.AuditLogging.ViewStatistics)]
