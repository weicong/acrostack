...
{
    [DbContext(typeof(AcroStackDbContext))]
    [Migration("20260903013157_RemoveAuditLogExcelFiles")]
    partial class RemoveAuditLogExcelFiles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AcroStack.AccountPro.ImpersonationSession", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("TenantId", "ImpersonatorUserId", "CreationTime");

                    b.HasIndex("TenantId", "TargetUserId", "CreationTime");

                    b.ToTable("AppImpersonationSessions", (string)null);
                });

            modelBuilder.Entity("AcroStack.AppUsers.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AcroStack.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AcroStack.Chat.ChatBlockedUser", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("AppChatBlockedUsers", (string)null);
                });

            modelBuilder.Entity("AcroStack.Chat.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AcroStack.Chat.ChatMessageReaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("TenantId", "ChatMessageId", "UserId", "Reaction")
                        .IsUnique();

                    b.ToTable("AppChatMessageReactions", (string)null);
                });

            modelBuilder.Entity("AcroStack.Chat.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<int>("LastMessageSide")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("TenantId", "UserId", "TargetUserId");

                    b.ToTable("AppChatConversations", (string)null);
                });

            modelBuilder.Entity("AcroStack.Chat.UserMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("AppChatUserMessages", (string)null);
                });

            modelBuilder.Entity("AcroStack.FileManagement.FileEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AcroStack.FileManagement.FileFolder", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("AppFileFolders", (string)null);
                });

            modelBuilder.Entity("AcroStack.FileManagement.FileShare", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("TenantId", "FileEntryId");

                    b.ToTable("AppFileShares", (string)null);
                });

            modelBuilder.Entity("AcroStack.FileManagement.FileVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("AppFileVersions", (string)null);
                });

            modelBuilder.Entity("Classroom.AnswerRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("SessionQuestionId", "LastSubmittedAt");

                    b.HasIndex("SessionQuestionId", "ParticipantId")
                        .IsUnique();

                    b.ToTable("ClsAnswerRecords", (string)null);
                });

            modelBuilder.Entity("Classroom.AnswerRevision", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("ClsAnswerRevisions", (string)null);
                });

            modelBuilder.Entity("Classroom.ClassSession", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<Guid?>("CurrentSessionQuestionId")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("ClsClassSessions", (string)null);
                });

            modelBuilder.Entity("Classroom.Participant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("ClsParticipants", (string)null);
                });

            modelBuilder.Entity("Classroom.Question", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("ClsQuestions", (string)null);
                });

            modelBuilder.Entity("Classroom.Quiz", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("ClsQuizzes", (string)null);
                });

            modelBuilder.Entity("Classroom.QuizQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("ClsQuizQuestions", (string)null);
                });

            modelBuilder.Entity("Classroom.SessionQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");

                    b.Property<DateTimeOffset?>("AnswerPublishedAt")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<DateTimeOffset?>("StatisticsPublishedAt")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("ClsSessionQuestions", (string)null);
                });
            ...
            modelBuilder.Entity("Classroom.Question", b =>
                {
                    b.OwnsMany("Classroom.QuestionOption", "Options", b1 =>
                        {
