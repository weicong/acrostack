...
export function createOtpFieldComponent<TFormValues extends ObjectFormValues>(
  form: AntdFormApi<TFormValues>,
): TypedOtpFieldComponent<TFormValues> {
  type OtpValue = ComponentProps<typeof Input.OTP>["value"];

  return function OtpField<TName extends OtpFieldName<TFormValues>>(
            ...
            {(isSubmitted) => {
              ...
              return (
                ...
                >
                  <Input.OTP
                    {...otpProps}
                    value={(field.state.value ?? "") as OtpValue}
