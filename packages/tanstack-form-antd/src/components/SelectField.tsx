...
export function createSelectFieldComponent<TFormValues extends ObjectFormValues>(
  form: AntdFormApi<TFormValues>,
): TypedSelectFieldComponent<TFormValues> {
  return function SelectField<TName extends SelectFieldName<TFormValues>>(
