...
export function createYearPickerFieldComponent<TFormValues extends ObjectFormValues>(
  form: AntdFormApi<TFormValues>,
): TypedYearPickerFieldComponent<TFormValues> {
  type YearValue = ComponentProps<typeof DatePicker>["value"];

  return function YearPickerField<TName extends YearPickerFieldName<TFormValues>>(
              ...
              if (resolved.mode === "view") {
                return (
                  <AntdForm.Item
                    ...
                    tooltip={tooltip}
                  >
                    <span>{getDateTimeViewValue(field.state.value, "YYYY")}</span>
                  </AntdForm.Item>
                );
              }
              ...
              return (
                ...
                >
                  <DatePicker
                    {...datePickerProps}
                    picker="year"
                    value={(field.state.value ?? null) as YearValue}
