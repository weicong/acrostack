...
export function createPasswordFieldComponent<TFormValues extends ObjectFormValues>(
  form: AntdFormApi<TFormValues>,
): TypedPasswordFieldComponent<TFormValues> {
  return function PasswordField<TName extends TextFieldName<TFormValues>>(
    props: PasswordFieldProps<TFormValues, TName>,
  ) {
    const {
      name,
      label,
