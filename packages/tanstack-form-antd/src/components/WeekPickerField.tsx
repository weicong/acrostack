...
export function createWeekPickerFieldComponent<TFormValues extends ObjectFormValues>(
  form: AntdFormApi<TFormValues>,
): TypedWeekPickerFieldComponent<TFormValues> {
  type WeekValue = ComponentProps<typeof DatePicker>["value"];

  return function WeekPickerField<TName extends WeekPickerFieldName<TFormValues>>(
              ...
              if (resolved.mode === "view") {
                return (
                  <AntdForm.Item
                    ...
                    tooltip={tooltip}
                  >
                    <span>{getDateTimeViewValue(field.state.value, "YYYY-MM-DD")}</span>
                  </AntdForm.Item>
                );
              }
              ...
              return (
                ...
                >
                  <DatePicker
                    {...datePickerProps}
                    picker="week"
                    value={(field.state.value ?? null) as WeekValue}
