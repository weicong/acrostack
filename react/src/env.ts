 ...
 * - 44317 for the API and Auth Server port
 * - AcroStack is replaced with the actual project name
 */
const apiUrl = import.meta.env.VITE_API_URL ?? 'https://localhost:44317'
const authUrl = import.meta.env.VITE_AUTH_URL ?? 'https://localhost:44317'
