...
export function getRoles(params?: PagedAndSortedResultRequestDto) {
  return api.get<PagedResultDto<IdentityRoleDto>>('/identity/roles', { params }).then((r) => r.data)
}
...
export function getUsers(params?: GetIdentityUsersInput) {
  return api.get<PagedResultDto<IdentityUserDto>>('/identity/users', { params }).then((r) => r.data)
}
...
export function getClaimTypes(params?: PagedAndSortedResultRequestDto) {
  return api.get<PagedResultDto<IdentityClaimTypeDto>>('/identity/claim-types', { params }).then((r) => r.data)
}
