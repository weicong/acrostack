...
export const blogFeatureGetOrDefaultQueryKey = ({
  path,
}: Omit<BlogFeatureGetOrDefaultOptions, "headers">) =>
  [{ url: "/api/cms-kit/blogs/:blogId/features/:featureName", params: path }] as const;
...
export function blogFeatureGetOrDefaultQueryOptions(
  { path }: BlogFeatureGetOrDefaultOptions,
...
>(
  {
    ...
    path: BlogFeatureGetOrDefaultOptions["path"] | (() => BlogFeatureGetOrDefaultOptions["path"]);
  },
  options: {
    query?: Partial<
      QueryObserverOptions<
