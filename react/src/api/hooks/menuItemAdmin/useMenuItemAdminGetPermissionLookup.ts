...
export const menuItemAdminGetPermissionLookupQueryKey = ({
  query,
}: Omit<MenuItemAdminGetPermissionLookupOptions, "headers"> = {}) =>
  [{ url: "/api/cms-kit-admin/menu-items/lookup/permissions" }, ...(query ? [query] : [])] as const;
...
export function menuItemAdminGetPermissionLookupQueryOptions(
  { query }: MenuItemAdminGetPermissionLookupOptions = {},
...
>(
  {
    ...
    query?:
      | MenuItemAdminGetPermissionLookupOptions["query"]
      | (() => MenuItemAdminGetPermissionLookupOptions["query"]);
  } = {},
  options: {
    query?: Partial<
  ...
  const queryKey =
    resolvedOptions?.queryKey ?? menuItemAdminGetPermissionLookupQueryKey(resolvedParams);
