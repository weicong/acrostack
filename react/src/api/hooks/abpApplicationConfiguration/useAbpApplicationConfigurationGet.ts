...
export const abpApplicationConfigurationGetQueryKey = ({
  query,
}: Omit<AbpApplicationConfigurationGetOptions, "headers"> = {}) =>
  [{ url: "/api/abp/application-configuration" }, ...(query ? [query] : [])] as const;
...
export function abpApplicationConfigurationGetQueryOptions(
  { query }: AbpApplicationConfigurationGetOptions = {},
...
>(
  {
    ...
    query?:
      | AbpApplicationConfigurationGetOptions["query"]
      | (() => AbpApplicationConfigurationGetOptions["query"]);
  } = {},
  options: {
    query?: Partial<
  ...
  const queryKey =
    resolvedOptions?.queryKey ?? abpApplicationConfigurationGetQueryKey(resolvedParams);
