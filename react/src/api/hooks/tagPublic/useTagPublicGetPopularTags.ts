...
export const tagPublicGetPopularTagsQueryKey = ({
  path,
}: Omit<TagPublicGetPopularTagsOptions, "headers">) =>
  [{ url: "/api/cms-kit-public/tags/popular/:entityType/:maxCount", params: path }] as const;
...
export function tagPublicGetPopularTagsQueryOptions(
  { path }: TagPublicGetPopularTagsOptions,
...
>(
  {
    ...
    path: TagPublicGetPopularTagsOptions["path"] | (() => TagPublicGetPopularTagsOptions["path"]);
  },
  options: {
    query?: Partial<
      QueryObserverOptions<
