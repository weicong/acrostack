...
export const commentAdminGetListQueryKey = ({
  query,
}: Omit<CommentAdminGetListOptions, "headers"> = {}) =>
  [{ url: "/api/cms-kit-admin/comments" }, ...(query ? [query] : [])] as const;
...
export function commentAdminGetListQueryOptions(
  { query }: CommentAdminGetListOptions = {},
...
>(
  {
    ...
    query?: CommentAdminGetListOptions["query"] | (() => CommentAdminGetListOptions["query"]);
  } = {},
  options: {
    query?: Partial<
      QueryObserverOptions<
