...
export const abpApiDefinitionGetQueryKey = ({
  query,
}: Omit<AbpApiDefinitionGetOptions, "headers"> = {}) =>
  [{ url: "/api/abp/api-definition" }, ...(query ? [query] : [])] as const;
...
export function abpApiDefinitionGetQueryOptions(
  { query }: AbpApiDefinitionGetOptions = {},
...
>(
  {
    ...
    query?: AbpApiDefinitionGetOptions["query"] | (() => AbpApiDefinitionGetOptions["query"]);
  } = {},
  options: {
    query?: Partial<
      QueryObserverOptions<
