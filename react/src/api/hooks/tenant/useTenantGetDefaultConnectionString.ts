...
export const tenantGetDefaultConnectionStringQueryKey = ({
  path,
}: Omit<TenantGetDefaultConnectionStringOptions, "headers">) =>
  [{ url: "/api/multi-tenancy/tenants/:id/default-connection-string", params: path }] as const;
...
export function tenantGetDefaultConnectionStringQueryOptions(
  { path }: TenantGetDefaultConnectionStringOptions,
...
>(
  {
    ...
    path:
      | TenantGetDefaultConnectionStringOptions["path"]
      | (() => TenantGetDefaultConnectionStringOptions["path"]);
  },
  options: {
    query?: Partial<
  ...
  const queryKey =
    resolvedOptions?.queryKey ?? tenantGetDefaultConnectionStringQueryKey(resolvedParams);
