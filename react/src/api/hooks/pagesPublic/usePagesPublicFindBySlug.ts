...
export const pagesPublicFindBySlugQueryKey = ({
  query,
}: Omit<PagesPublicFindBySlugOptions, "headers"> = {}) =>
  [{ url: "/api/cms-kit-public/pages/by-slug" }, ...(query ? [query] : [])] as const;
...
export function pagesPublicFindBySlugQueryOptions(
  { query }: PagesPublicFindBySlugOptions = {},
...
>(
  {
    ...
    query?: PagesPublicFindBySlugOptions["query"] | (() => PagesPublicFindBySlugOptions["query"]);
  } = {},
  options: {
    query?: Partial<
      QueryObserverOptions<
