...
export const blogPostPublicGetAuthorsHasBlogPostsQueryKey = ({
  query,
}: Omit<BlogPostPublicGetAuthorsHasBlogPostsOptions, "headers"> = {}) =>
  [{ url: "/api/cms-kit-public/blog-posts/authors" }, ...(query ? [query] : [])] as const;
...
export function blogPostPublicGetAuthorsHasBlogPostsQueryOptions(
  { query }: BlogPostPublicGetAuthorsHasBlogPostsOptions = {},
...
>(
  {
    ...
    query?:
      | BlogPostPublicGetAuthorsHasBlogPostsOptions["query"]
      | (() => BlogPostPublicGetAuthorsHasBlogPostsOptions["query"]);
  } = {},
  options: {
    query?: Partial<
  ...
  const queryKey =
    resolvedOptions?.queryKey ?? blogPostPublicGetAuthorsHasBlogPostsQueryKey(resolvedParams);
