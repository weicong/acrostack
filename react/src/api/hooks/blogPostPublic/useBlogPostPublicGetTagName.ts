...
export const blogPostPublicGetTagNameQueryKey = ({
  path,
  query,
}: Omit<BlogPostPublicGetTagNameOptions, "headers">) =>
  [
    { url: "/api/cms-kit-public/blog-posts/tags/:id", params: path },
    ...(query ? [query] : []),
  ] as const;
...
>(
  {
    ...
    path: BlogPostPublicGetTagNameOptions["path"] | (() => BlogPostPublicGetTagNameOptions["path"]);
    query?:
      | BlogPostPublicGetTagNameOptions["query"]
      | (() => BlogPostPublicGetTagNameOptions["query"]);
  },
  options: {
    query?: Partial<
