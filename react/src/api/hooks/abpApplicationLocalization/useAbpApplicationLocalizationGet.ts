...
export const abpApplicationLocalizationGetQueryKey = ({
  query,
}: Omit<AbpApplicationLocalizationGetOptions, "headers">) =>
  [{ url: "/api/abp/application-localization" }, ...(query ? [query] : [])] as const;
...
export function abpApplicationLocalizationGetQueryOptions(
  { query }: AbpApplicationLocalizationGetOptions,
...
>(
  {
    ...
    query:
      | AbpApplicationLocalizationGetOptions["query"]
      | (() => AbpApplicationLocalizationGetOptions["query"]);
  },
  options: {
    query?: Partial<
  ...
  const queryKey =
    resolvedOptions?.queryKey ?? abpApplicationLocalizationGetQueryKey(resolvedParams);
