...
export const permissionsSearchResourceProviderKeyQueryKey = ({
  query,
}: Omit<PermissionsSearchResourceProviderKeyOptions, "headers"> = {}) =>
  [
...
export function permissionsSearchResourceProviderKeyQueryOptions(
  { query }: PermissionsSearchResourceProviderKeyOptions = {},
  ...
  >({
    ...
    queryFn: async ({ signal }) => {
      const { data } = await permissionsSearchResourceProviderKey({
        ...config,
        query,
...
>(
  {
    ...
    query?:
      | PermissionsSearchResourceProviderKeyOptions["query"]
      | (() => PermissionsSearchResourceProviderKeyOptions["query"]);
  } = {},
  options: {
    query?: Partial<
  ...
  const queryKey =
    resolvedOptions?.queryKey ?? permissionsSearchResourceProviderKeyQueryKey(resolvedParams);
