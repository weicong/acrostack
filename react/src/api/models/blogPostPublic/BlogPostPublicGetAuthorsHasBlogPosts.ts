 ...
 */
export type BlogPostPublicGetAuthorsHasBlogPostsQueryFilter = string | undefined;

/**
 * @type string | undefined
 */
export type BlogPostPublicGetAuthorsHasBlogPostsQuerySorting = string | undefined;
 ...
 */
export type BlogPostPublicGetAuthorsHasBlogPostsQuerySkipCount = number | undefined;
 ...
 * @type integer | undefined
 */
export type BlogPostPublicGetAuthorsHasBlogPostsQueryMaxResultCount = number | undefined;
 ...
 * @type object
 */
export type BlogPostPublicGetAuthorsHasBlogPostsRequestConfig = {
  data?: never;
  pathParams?: never;
  /**
...
export type BlogPostPublicGetAuthorsHasBlogPostsResponses = {
  "200": BlogPostPublicGetAuthorsHasBlogPostsStatus200;
  "400": BlogPostPublicGetAuthorsHasBlogPostsStatus400;
  "401": BlogPostPublicGetAuthorsHasBlogPostsStatus401;
  "403": BlogPostPublicGetAuthorsHasBlogPostsStatus403;
  "404": BlogPostPublicGetAuthorsHasBlogPostsStatus404;
  "500": BlogPostPublicGetAuthorsHasBlogPostsStatus500;
  "501": BlogPostPublicGetAuthorsHasBlogPostsStatus501;
};
