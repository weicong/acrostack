...
export type MenuItemAdminCreateBodyJson =
  | Omit<NonNullable<VoloCmsKitAdminMenusMenuItemCreateInput>, "extraProperties">
  | undefined;

export type MenuItemAdminCreateBodyJson2 =
  | Omit<NonNullable<VoloCmsKitAdminMenusMenuItemCreateInput>, "extraProperties">
  | undefined;

export type MenuItemAdminCreateBodyJson3 =
  | Omit<NonNullable<VoloCmsKitAdminMenusMenuItemCreateInput>, "extraProperties">
  | undefined;

export type MenuItemAdminCreateBody =
  | MenuItemAdminCreateBodyJson
  | MenuItemAdminCreateBodyJson2
  | MenuItemAdminCreateBodyJson3;
