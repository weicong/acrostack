...
export type MenuItemAdminUpdateBodyJson =
  | Omit<NonNullable<VoloCmsKitAdminMenusMenuItemUpdateInput>, "extraProperties">
  | undefined;

export type MenuItemAdminUpdateBodyJson2 =
  | Omit<NonNullable<VoloCmsKitAdminMenusMenuItemUpdateInput>, "extraProperties">
  | undefined;

export type MenuItemAdminUpdateBodyJson3 =
  | Omit<NonNullable<VoloCmsKitAdminMenusMenuItemUpdateInput>, "extraProperties">
  | undefined;

export type MenuItemAdminUpdateBody =
  | MenuItemAdminUpdateBodyJson
  | MenuItemAdminUpdateBodyJson2
  | MenuItemAdminUpdateBodyJson3;
