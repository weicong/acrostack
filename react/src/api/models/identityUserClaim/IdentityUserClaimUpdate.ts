...
export type IdentityUserClaimUpdateBodyJson =
  | AcroStackIdentityClaimsUpdateIdentityClaimDto
  | undefined;

export type IdentityUserClaimUpdateBodyJson2 =
  | AcroStackIdentityClaimsUpdateIdentityClaimDto
  | undefined;

export type IdentityUserClaimUpdateBodyJson3 =
  | AcroStackIdentityClaimsUpdateIdentityClaimDto
  | undefined;

export type IdentityUserClaimUpdateBody =
  | IdentityUserClaimUpdateBodyJson
  | IdentityUserClaimUpdateBodyJson2
  | IdentityUserClaimUpdateBodyJson3;
