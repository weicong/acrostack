...
export type TenantUpdateStatus200 = (TenantUpdateStatus200Plain | TenantUpdateStatus200Json | TenantUpdateStatus200Json2);
...
export type TenantUpdateStatus400 = (TenantUpdateStatus400Plain | TenantUpdateStatus400Json | TenantUpdateStatus400Json2);
...
export type TenantUpdateStatus401 = (TenantUpdateStatus401Plain | TenantUpdateStatus401Json | TenantUpdateStatus401Json2);
...
export type TenantUpdateStatus403 = (TenantUpdateStatus403Plain | TenantUpdateStatus403Json | TenantUpdateStatus403Json2);
...
export type TenantUpdateStatus404 = (TenantUpdateStatus404Plain | TenantUpdateStatus404Json | TenantUpdateStatus404Json2);
...
export type TenantUpdateStatus500 = (TenantUpdateStatus500Plain | TenantUpdateStatus500Json | TenantUpdateStatus500Json2);
...
export type TenantUpdateStatus501 = (TenantUpdateStatus501Plain | TenantUpdateStatus501Json | TenantUpdateStatus501Json2);

export type TenantUpdateBodyJson = Omit<NonNullable<VoloAbpTenantManagementTenantUpdateDto>, "extraProperties"> | undefined;

export type TenantUpdateBodyJson2 = Omit<NonNullable<VoloAbpTenantManagementTenantUpdateDto>, "extraProperties"> | undefined;

export type TenantUpdateBodyJson3 = Omit<NonNullable<VoloAbpTenantManagementTenantUpdateDto>, "extraProperties"> | undefined;
...
*/
export type TenantUpdateResponse = (TenantUpdateStatus200 | TenantUpdateStatus400 | TenantUpdateStatus401 | TenantUpdateStatus403 | TenantUpdateStatus404 | TenantUpdateStatus500 | TenantUpdateStatus501);
