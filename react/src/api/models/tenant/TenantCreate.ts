...
export type TenantCreateStatus200 = (TenantCreateStatus200Plain | TenantCreateStatus200Json | TenantCreateStatus200Json2);
...
export type TenantCreateStatus400 = (TenantCreateStatus400Plain | TenantCreateStatus400Json | TenantCreateStatus400Json2);
...
export type TenantCreateStatus401 = (TenantCreateStatus401Plain | TenantCreateStatus401Json | TenantCreateStatus401Json2);
...
export type TenantCreateStatus403 = (TenantCreateStatus403Plain | TenantCreateStatus403Json | TenantCreateStatus403Json2);
...
export type TenantCreateStatus404 = (TenantCreateStatus404Plain | TenantCreateStatus404Json | TenantCreateStatus404Json2);
...
export type TenantCreateStatus500 = (TenantCreateStatus500Plain | TenantCreateStatus500Json | TenantCreateStatus500Json2);
...
export type TenantCreateStatus501 = (TenantCreateStatus501Plain | TenantCreateStatus501Json | TenantCreateStatus501Json2);

export type TenantCreateBodyJson = Omit<NonNullable<VoloAbpTenantManagementTenantCreateDto>, "extraProperties"> | undefined;

export type TenantCreateBodyJson2 = Omit<NonNullable<VoloAbpTenantManagementTenantCreateDto>, "extraProperties"> | undefined;

export type TenantCreateBodyJson3 = Omit<NonNullable<VoloAbpTenantManagementTenantCreateDto>, "extraProperties"> | undefined;
...
*/
export type TenantCreateResponse = (TenantCreateStatus200 | TenantCreateStatus400 | TenantCreateStatus401 | TenantCreateStatus403 | TenantCreateStatus404 | TenantCreateStatus500 | TenantCreateStatus501);
