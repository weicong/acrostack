...
export type TagAdminUpdateStatus200 = (TagAdminUpdateStatus200Plain | TagAdminUpdateStatus200Json | TagAdminUpdateStatus200Json2);
...
export type TagAdminUpdateStatus400 = (TagAdminUpdateStatus400Plain | TagAdminUpdateStatus400Json | TagAdminUpdateStatus400Json2);
...
export type TagAdminUpdateStatus401 = (TagAdminUpdateStatus401Plain | TagAdminUpdateStatus401Json | TagAdminUpdateStatus401Json2);
...
export type TagAdminUpdateStatus403 = (TagAdminUpdateStatus403Plain | TagAdminUpdateStatus403Json | TagAdminUpdateStatus403Json2);
...
export type TagAdminUpdateStatus404 = (TagAdminUpdateStatus404Plain | TagAdminUpdateStatus404Json | TagAdminUpdateStatus404Json2);
...
export type TagAdminUpdateStatus500 = (TagAdminUpdateStatus500Plain | TagAdminUpdateStatus500Json | TagAdminUpdateStatus500Json2);
...
export type TagAdminUpdateStatus501 = (TagAdminUpdateStatus501Plain | TagAdminUpdateStatus501Json | TagAdminUpdateStatus501Json2);

export type TagAdminUpdateBodyJson = Omit<NonNullable<VoloCmsKitAdminTagsTagUpdateDto>, "extraProperties"> | undefined;

export type TagAdminUpdateBodyJson2 = Omit<NonNullable<VoloCmsKitAdminTagsTagUpdateDto>, "extraProperties"> | undefined;

export type TagAdminUpdateBodyJson3 = Omit<NonNullable<VoloCmsKitAdminTagsTagUpdateDto>, "extraProperties"> | undefined;

export type TagAdminUpdateBody = (TagAdminUpdateBodyJson | TagAdminUpdateBodyJson2 | TagAdminUpdateBodyJson3);
...
*/
export type TagAdminUpdateResponse = (TagAdminUpdateStatus200 | TagAdminUpdateStatus400 | TagAdminUpdateStatus401 | TagAdminUpdateStatus403 | TagAdminUpdateStatus404 | TagAdminUpdateStatus500 | TagAdminUpdateStatus501);
