...
export type TagAdminCreateStatus200 = (TagAdminCreateStatus200Plain | TagAdminCreateStatus200Json | TagAdminCreateStatus200Json2);
...
export type TagAdminCreateStatus400 = (TagAdminCreateStatus400Plain | TagAdminCreateStatus400Json | TagAdminCreateStatus400Json2);
...
export type TagAdminCreateStatus401 = (TagAdminCreateStatus401Plain | TagAdminCreateStatus401Json | TagAdminCreateStatus401Json2);
...
export type TagAdminCreateStatus403 = (TagAdminCreateStatus403Plain | TagAdminCreateStatus403Json | TagAdminCreateStatus403Json2);
...
export type TagAdminCreateStatus404 = (TagAdminCreateStatus404Plain | TagAdminCreateStatus404Json | TagAdminCreateStatus404Json2);
...
export type TagAdminCreateStatus500 = (TagAdminCreateStatus500Plain | TagAdminCreateStatus500Json | TagAdminCreateStatus500Json2);
...
export type TagAdminCreateStatus501 = (TagAdminCreateStatus501Plain | TagAdminCreateStatus501Json | TagAdminCreateStatus501Json2);

export type TagAdminCreateBodyJson = Omit<NonNullable<VoloCmsKitAdminTagsTagCreateDto>, "extraProperties"> | undefined;

export type TagAdminCreateBodyJson2 = Omit<NonNullable<VoloCmsKitAdminTagsTagCreateDto>, "extraProperties"> | undefined;

export type TagAdminCreateBodyJson3 = Omit<NonNullable<VoloCmsKitAdminTagsTagCreateDto>, "extraProperties"> | undefined;

export type TagAdminCreateBody = (TagAdminCreateBodyJson | TagAdminCreateBodyJson2 | TagAdminCreateBodyJson3);
...
*/
export type TagAdminCreateResponse = (TagAdminCreateStatus200 | TagAdminCreateStatus400 | TagAdminCreateStatus401 | TagAdminCreateStatus403 | TagAdminCreateStatus404 | TagAdminCreateStatus500 | TagAdminCreateStatus501);
