...
export type BlogAdminCreateStatus200 = (BlogAdminCreateStatus200Plain | BlogAdminCreateStatus200Json | BlogAdminCreateStatus200Json2);
...
export type BlogAdminCreateStatus400 = (BlogAdminCreateStatus400Plain | BlogAdminCreateStatus400Json | BlogAdminCreateStatus400Json2);
...
export type BlogAdminCreateStatus401 = (BlogAdminCreateStatus401Plain | BlogAdminCreateStatus401Json | BlogAdminCreateStatus401Json2);
...
export type BlogAdminCreateStatus403 = (BlogAdminCreateStatus403Plain | BlogAdminCreateStatus403Json | BlogAdminCreateStatus403Json2);
...
export type BlogAdminCreateStatus404 = (BlogAdminCreateStatus404Plain | BlogAdminCreateStatus404Json | BlogAdminCreateStatus404Json2);
...
export type BlogAdminCreateStatus500 = (BlogAdminCreateStatus500Plain | BlogAdminCreateStatus500Json | BlogAdminCreateStatus500Json2);
...
export type BlogAdminCreateStatus501 = (BlogAdminCreateStatus501Plain | BlogAdminCreateStatus501Json | BlogAdminCreateStatus501Json2);

export type BlogAdminCreateBodyJson = Omit<NonNullable<VoloCmsKitAdminBlogsCreateBlogDto>, "extraProperties"> | undefined;

export type BlogAdminCreateBodyJson2 = Omit<NonNullable<VoloCmsKitAdminBlogsCreateBlogDto>, "extraProperties"> | undefined;

export type BlogAdminCreateBodyJson3 = Omit<NonNullable<VoloCmsKitAdminBlogsCreateBlogDto>, "extraProperties"> | undefined;

export type BlogAdminCreateBody = (BlogAdminCreateBodyJson | BlogAdminCreateBodyJson2 | BlogAdminCreateBodyJson3);
...
*/
export type BlogAdminCreateResponse = (BlogAdminCreateStatus200 | BlogAdminCreateStatus400 | BlogAdminCreateStatus401 | BlogAdminCreateStatus403 | BlogAdminCreateStatus404 | BlogAdminCreateStatus500 | BlogAdminCreateStatus501);
