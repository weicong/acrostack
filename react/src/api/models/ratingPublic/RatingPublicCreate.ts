...
export type RatingPublicCreateBodyJson2 =
  | VoloCmsKitPublicRatingsCreateUpdateRatingInput
  | undefined;

export type RatingPublicCreateBodyJson3 =
  | VoloCmsKitPublicRatingsCreateUpdateRatingInput
  | undefined;

export type RatingPublicCreateBody =
  | RatingPublicCreateBodyJson
  | RatingPublicCreateBodyJson2
  | RatingPublicCreateBodyJson3;
