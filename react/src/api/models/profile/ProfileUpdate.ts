...
export type ProfileUpdateBodyJson =
  | Omit<NonNullable<VoloAbpAccountUpdateProfileDto>, "extraProperties">
  | undefined;

export type ProfileUpdateBodyJson2 =
  | Omit<NonNullable<VoloAbpAccountUpdateProfileDto>, "extraProperties">
  | undefined;

export type ProfileUpdateBodyJson3 =
  | Omit<NonNullable<VoloAbpAccountUpdateProfileDto>, "extraProperties">
  | undefined;

export type ProfileUpdateBody =
  | ProfileUpdateBodyJson
  | ProfileUpdateBodyJson2
  | ProfileUpdateBodyJson3;
