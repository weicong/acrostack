...
export type OpenIddictApplicationCreateBody =
  | OpenIddictApplicationCreateBodyJson
  | OpenIddictApplicationCreateBodyJson2
  | OpenIddictApplicationCreateBodyJson3;
