...
export type PermissionsUpdateBodyJson2 =
  | VoloAbpPermissionManagementUpdatePermissionsDto
  | undefined;

export type PermissionsUpdateBodyJson3 =
  | VoloAbpPermissionManagementUpdatePermissionsDto
  | undefined;

export type PermissionsUpdateBody =
  | PermissionsUpdateBodyJson
  | PermissionsUpdateBodyJson2
  | PermissionsUpdateBodyJson3;
