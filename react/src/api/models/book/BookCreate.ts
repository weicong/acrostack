...
export type BookCreateStatus200 = (BookCreateStatus200Plain | BookCreateStatus200Json | BookCreateStatus200Json2);
...
export type BookCreateStatus400 = (BookCreateStatus400Plain | BookCreateStatus400Json | BookCreateStatus400Json2);
...
export type BookCreateStatus401 = (BookCreateStatus401Plain | BookCreateStatus401Json | BookCreateStatus401Json2);
...
export type BookCreateStatus403 = (BookCreateStatus403Plain | BookCreateStatus403Json | BookCreateStatus403Json2);
...
export type BookCreateStatus404 = (BookCreateStatus404Plain | BookCreateStatus404Json | BookCreateStatus404Json2);
...
export type BookCreateStatus500 = (BookCreateStatus500Plain | BookCreateStatus500Json | BookCreateStatus500Json2);
...
export type BookCreateStatus501 = (BookCreateStatus501Plain | BookCreateStatus501Json | BookCreateStatus501Json2);
...
*/
export type BookCreateResponse = (BookCreateStatus200 | BookCreateStatus400 | BookCreateStatus401 | BookCreateStatus403 | BookCreateStatus404 | BookCreateStatus500 | BookCreateStatus501);
