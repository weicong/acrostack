...
export type CommentPublicUpdateBodyJson =
  | Omit<NonNullable<VoloCmsKitPublicCommentsUpdateCommentInput>, "extraProperties">
  | undefined;

export type CommentPublicUpdateBodyJson2 =
  | Omit<NonNullable<VoloCmsKitPublicCommentsUpdateCommentInput>, "extraProperties">
  | undefined;

export type CommentPublicUpdateBodyJson3 =
  | Omit<NonNullable<VoloCmsKitPublicCommentsUpdateCommentInput>, "extraProperties">
  | undefined;

export type CommentPublicUpdateBody =
  | CommentPublicUpdateBodyJson
  | CommentPublicUpdateBodyJson2
  | CommentPublicUpdateBodyJson3;
