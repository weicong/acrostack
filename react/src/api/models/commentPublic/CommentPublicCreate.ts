...
export type CommentPublicCreateBodyJson =
  | Omit<NonNullable<VoloCmsKitPublicCommentsCreateCommentInput>, "extraProperties">
  | undefined;

export type CommentPublicCreateBodyJson2 =
  | Omit<NonNullable<VoloCmsKitPublicCommentsCreateCommentInput>, "extraProperties">
  | undefined;

export type CommentPublicCreateBodyJson3 =
  | Omit<NonNullable<VoloCmsKitPublicCommentsCreateCommentInput>, "extraProperties">
  | undefined;

export type CommentPublicCreateBody =
  | CommentPublicCreateBodyJson
  | CommentPublicCreateBodyJson2
  | CommentPublicCreateBodyJson3;
