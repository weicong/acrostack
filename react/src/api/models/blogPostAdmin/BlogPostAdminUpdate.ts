...
export type BlogPostAdminUpdateBodyJson =
  | Omit<NonNullable<VoloCmsKitAdminBlogsUpdateBlogPostDto>, "extraProperties">
  | undefined;

export type BlogPostAdminUpdateBodyJson2 =
  | Omit<NonNullable<VoloCmsKitAdminBlogsUpdateBlogPostDto>, "extraProperties">
  | undefined;

export type BlogPostAdminUpdateBodyJson3 =
  | Omit<NonNullable<VoloCmsKitAdminBlogsUpdateBlogPostDto>, "extraProperties">
  | undefined;

export type BlogPostAdminUpdateBody =
  | BlogPostAdminUpdateBodyJson
  | BlogPostAdminUpdateBodyJson2
  | BlogPostAdminUpdateBodyJson3;
