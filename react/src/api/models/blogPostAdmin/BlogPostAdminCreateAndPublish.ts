...
export type BlogPostAdminCreateAndPublishBodyJson =
  | Omit<NonNullable<VoloCmsKitAdminBlogsCreateBlogPostDto>, "extraProperties">
  | undefined;

export type BlogPostAdminCreateAndPublishBodyJson2 =
  | Omit<NonNullable<VoloCmsKitAdminBlogsCreateBlogPostDto>, "extraProperties">
  | undefined;

export type BlogPostAdminCreateAndPublishBodyJson3 =
  | Omit<NonNullable<VoloCmsKitAdminBlogsCreateBlogPostDto>, "extraProperties">
  | undefined;

export type BlogPostAdminCreateAndPublishBody =
  | BlogPostAdminCreateAndPublishBodyJson
  | BlogPostAdminCreateAndPublishBodyJson2
  | BlogPostAdminCreateAndPublishBodyJson3;
