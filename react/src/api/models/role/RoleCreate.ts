...
export type RoleCreateStatus200 = (RoleCreateStatus200Plain | RoleCreateStatus200Json | RoleCreateStatus200Json2);
...
export type RoleCreateStatus400 = (RoleCreateStatus400Plain | RoleCreateStatus400Json | RoleCreateStatus400Json2);
...
export type RoleCreateStatus401 = (RoleCreateStatus401Plain | RoleCreateStatus401Json | RoleCreateStatus401Json2);
...
export type RoleCreateStatus403 = (RoleCreateStatus403Plain | RoleCreateStatus403Json | RoleCreateStatus403Json2);
...
export type RoleCreateStatus404 = (RoleCreateStatus404Plain | RoleCreateStatus404Json | RoleCreateStatus404Json2);
...
export type RoleCreateStatus500 = (RoleCreateStatus500Plain | RoleCreateStatus500Json | RoleCreateStatus500Json2);
...
export type RoleCreateStatus501 = (RoleCreateStatus501Plain | RoleCreateStatus501Json | RoleCreateStatus501Json2);

export type RoleCreateBodyJson = Omit<NonNullable<VoloAbpIdentityIdentityRoleCreateDto>, "extraProperties"> | undefined;

export type RoleCreateBodyJson2 = Omit<NonNullable<VoloAbpIdentityIdentityRoleCreateDto>, "extraProperties"> | undefined;

export type RoleCreateBodyJson3 = Omit<NonNullable<VoloAbpIdentityIdentityRoleCreateDto>, "extraProperties"> | undefined;
...
*/
export type RoleCreateResponse = (RoleCreateStatus200 | RoleCreateStatus400 | RoleCreateStatus401 | RoleCreateStatus403 | RoleCreateStatus404 | RoleCreateStatus500 | RoleCreateStatus501);
