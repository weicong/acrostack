...
export type FileManagementCreateFolderBodyJson =
  | AcroStackFileManagementCreateFileFolderDto
  | undefined;

export type FileManagementCreateFolderBodyJson2 =
  | AcroStackFileManagementCreateFileFolderDto
  | undefined;

export type FileManagementCreateFolderBodyJson3 =
  | AcroStackFileManagementCreateFileFolderDto
  | undefined;

export type FileManagementCreateFolderBody =
  | FileManagementCreateFolderBodyJson
  | FileManagementCreateFolderBodyJson2
  | FileManagementCreateFolderBodyJson3;
