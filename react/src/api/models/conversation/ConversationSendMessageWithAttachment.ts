...
export type ConversationSendMessageWithAttachmentBodyJson =
  | AcroStackChatSendMessageInput
  | undefined;

export type ConversationSendMessageWithAttachmentBodyJson2 =
  | AcroStackChatSendMessageInput
  | undefined;

export type ConversationSendMessageWithAttachmentBodyJson3 =
  | AcroStackChatSendMessageInput
  | undefined;

export type ConversationSendMessageWithAttachmentBody =
  | ConversationSendMessageWithAttachmentBodyJson
  | ConversationSendMessageWithAttachmentBodyJson2
  | ConversationSendMessageWithAttachmentBodyJson3;
