...
export type PageAdminUpdateStatus200 = (PageAdminUpdateStatus200Plain | PageAdminUpdateStatus200Json | PageAdminUpdateStatus200Json2);
...
export type PageAdminUpdateStatus400 = (PageAdminUpdateStatus400Plain | PageAdminUpdateStatus400Json | PageAdminUpdateStatus400Json2);
...
export type PageAdminUpdateStatus401 = (PageAdminUpdateStatus401Plain | PageAdminUpdateStatus401Json | PageAdminUpdateStatus401Json2);
...
export type PageAdminUpdateStatus403 = (PageAdminUpdateStatus403Plain | PageAdminUpdateStatus403Json | PageAdminUpdateStatus403Json2);
...
export type PageAdminUpdateStatus404 = (PageAdminUpdateStatus404Plain | PageAdminUpdateStatus404Json | PageAdminUpdateStatus404Json2);
...
export type PageAdminUpdateStatus500 = (PageAdminUpdateStatus500Plain | PageAdminUpdateStatus500Json | PageAdminUpdateStatus500Json2);
...
export type PageAdminUpdateStatus501 = (PageAdminUpdateStatus501Plain | PageAdminUpdateStatus501Json | PageAdminUpdateStatus501Json2);

export type PageAdminUpdateBodyJson = Omit<NonNullable<VoloCmsKitAdminPagesUpdatePageInputDto>, "extraProperties"> | undefined;

export type PageAdminUpdateBodyJson2 = Omit<NonNullable<VoloCmsKitAdminPagesUpdatePageInputDto>, "extraProperties"> | undefined;

export type PageAdminUpdateBodyJson3 = Omit<NonNullable<VoloCmsKitAdminPagesUpdatePageInputDto>, "extraProperties"> | undefined;

export type PageAdminUpdateBody = (PageAdminUpdateBodyJson | PageAdminUpdateBodyJson2 | PageAdminUpdateBodyJson3);
...
*/
export type PageAdminUpdateResponse = (PageAdminUpdateStatus200 | PageAdminUpdateStatus400 | PageAdminUpdateStatus401 | PageAdminUpdateStatus403 | PageAdminUpdateStatus404 | PageAdminUpdateStatus500 | PageAdminUpdateStatus501);
