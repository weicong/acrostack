...
export type PageAdminCreateBodyJson =
  | Omit<NonNullable<VoloCmsKitAdminPagesCreatePageInputDto>, "extraProperties">
  | undefined;

export type PageAdminCreateBodyJson2 =
  | Omit<NonNullable<VoloCmsKitAdminPagesCreatePageInputDto>, "extraProperties">
  | undefined;

export type PageAdminCreateBodyJson3 =
  | Omit<NonNullable<VoloCmsKitAdminPagesCreatePageInputDto>, "extraProperties">
  | undefined;

export type PageAdminCreateBody =
  | PageAdminCreateBodyJson
  | PageAdminCreateBodyJson2
  | PageAdminCreateBodyJson3;
