...
export type CommentAdminUpdateApprovalStatusBodyJson =
  | VoloCmsKitAdminCommentsCommentApprovalDto
  | undefined;

export type CommentAdminUpdateApprovalStatusBodyJson2 =
  | VoloCmsKitAdminCommentsCommentApprovalDto
  | undefined;

export type CommentAdminUpdateApprovalStatusBodyJson3 =
  | VoloCmsKitAdminCommentsCommentApprovalDto
  | undefined;

export type CommentAdminUpdateApprovalStatusBody =
  | CommentAdminUpdateApprovalStatusBodyJson
  | CommentAdminUpdateApprovalStatusBodyJson2
  | CommentAdminUpdateApprovalStatusBodyJson3;
