...
export type AppUserGetListStatus200Plain = VoloAbpApplicationDtosPagedResultDto1AcroStackAppUsersAppUserDtoAcroStackAppUsersVersion1000CultureneutralPublicKeyTokennull;

export type AppUserGetListStatus200Json = VoloAbpApplicationDtosPagedResultDto1AcroStackAppUsersAppUserDtoAcroStackAppUsersVersion1000CultureneutralPublicKeyTokennull;

export type AppUserGetListStatus200Json2 = VoloAbpApplicationDtosPagedResultDto1AcroStackAppUsersAppUserDtoAcroStackAppUsersVersion1000CultureneutralPublicKeyTokennull;

export type AppUserGetListStatus200 = (AppUserGetListStatus200Plain | AppUserGetListStatus200Json | AppUserGetListStatus200Json2);
...
export type AppUserGetListStatus400 = (AppUserGetListStatus400Plain | AppUserGetListStatus400Json | AppUserGetListStatus400Json2);
...
export type AppUserGetListStatus401 = (AppUserGetListStatus401Plain | AppUserGetListStatus401Json | AppUserGetListStatus401Json2);
...
export type AppUserGetListStatus403 = (AppUserGetListStatus403Plain | AppUserGetListStatus403Json | AppUserGetListStatus403Json2);
...
export type AppUserGetListStatus404 = (AppUserGetListStatus404Plain | AppUserGetListStatus404Json | AppUserGetListStatus404Json2);
...
export type AppUserGetListStatus500 = (AppUserGetListStatus500Plain | AppUserGetListStatus500Json | AppUserGetListStatus500Json2);
...
export type AppUserGetListStatus501 = (AppUserGetListStatus501Plain | AppUserGetListStatus501Json | AppUserGetListStatus501Json2);
...
*/
export type AppUserGetListResponse = (AppUserGetListStatus200 | AppUserGetListStatus400 | AppUserGetListStatus401 | AppUserGetListStatus403 | AppUserGetListStatus404 | AppUserGetListStatus500 | AppUserGetListStatus501);
