...
export type EmailSettingsUpdateBodyJson =
  | VoloAbpSettingManagementUpdateEmailSettingsDto
  | undefined;

export type EmailSettingsUpdateBodyJson2 =
  | VoloAbpSettingManagementUpdateEmailSettingsDto
  | undefined;

export type EmailSettingsUpdateBodyJson3 =
  | VoloAbpSettingManagementUpdateEmailSettingsDto
  | undefined;

export type EmailSettingsUpdateBody =
  | EmailSettingsUpdateBodyJson
  | EmailSettingsUpdateBodyJson2
  | EmailSettingsUpdateBodyJson3;
