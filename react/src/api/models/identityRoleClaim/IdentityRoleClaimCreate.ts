...
export type IdentityRoleClaimCreateBodyJson =
  | AcroStackIdentityClaimsCreateIdentityRoleClaimDto
  | undefined;

export type IdentityRoleClaimCreateBodyJson2 =
  | AcroStackIdentityClaimsCreateIdentityRoleClaimDto
  | undefined;

export type IdentityRoleClaimCreateBodyJson3 =
  | AcroStackIdentityClaimsCreateIdentityRoleClaimDto
  | undefined;

export type IdentityRoleClaimCreateBody =
  | IdentityRoleClaimCreateBodyJson
  | IdentityRoleClaimCreateBodyJson2
  | IdentityRoleClaimCreateBodyJson3;
