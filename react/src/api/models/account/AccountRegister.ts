...
export type AccountRegisterBodyJson =
  | Omit<NonNullable<VoloAbpAccountRegisterDto>, "extraProperties">
  | undefined;

export type AccountRegisterBodyJson2 =
  | Omit<NonNullable<VoloAbpAccountRegisterDto>, "extraProperties">
  | undefined;

export type AccountRegisterBodyJson3 =
  | Omit<NonNullable<VoloAbpAccountRegisterDto>, "extraProperties">
  | undefined;

export type AccountRegisterBody =
  | AccountRegisterBodyJson
  | AccountRegisterBodyJson2
  | AccountRegisterBodyJson3;
