...
export type AccountVerifyPasswordResetTokenBodyJson =
  | VoloAbpAccountVerifyPasswordResetTokenInput
  | undefined;

export type AccountVerifyPasswordResetTokenBodyJson2 =
  | VoloAbpAccountVerifyPasswordResetTokenInput
  | undefined;

export type AccountVerifyPasswordResetTokenBodyJson3 =
  | VoloAbpAccountVerifyPasswordResetTokenInput
  | undefined;

export type AccountVerifyPasswordResetTokenBody =
  | AccountVerifyPasswordResetTokenBodyJson
  | AccountVerifyPasswordResetTokenBodyJson2
  | AccountVerifyPasswordResetTokenBodyJson3;
